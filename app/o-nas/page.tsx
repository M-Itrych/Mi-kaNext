    ...
    <div className="pt-4 sm:pt-8 md:pt-12">
      <div className="max-w-full">
        <div className="flex flex-col items-center p-4 sm:p-6 md:p-8 lg:p-12 gap-4 sm:gap-6 rounded-[0.3125rem] bg-white max-w-4xl mx-auto">
          <h1 className="text-[#0F172A] self-stretch text-center font-urbanist text-3xl sm:text-4xl md:text-5xl font-bold leading-[140%] tracking-[-0.0225rem]">
            MI-KA
          </h1>
          <p className="text-[rgba(15,23,42,0.75)] font-inter text-sm sm:text-base font-normal leading-[150%]">
      ...
      <InfoCardsProvider>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 bg-white py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-[12.5rem] items-center gap-6 md:gap-8 lg:gap-12">
          {cards.map((card) => (
